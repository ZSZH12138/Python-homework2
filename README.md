...
The first file is preview\_of\_data.py which shows the based style of all the graphs.  
...
注意2：Mission 4-3我只绘制了底部的等高线 因为侧面等高线不管怎么画颜色都不对 问了AI也无法解决  

The file of Latex is my report code. The directory of fig is used in the report code for providing pictures.  
